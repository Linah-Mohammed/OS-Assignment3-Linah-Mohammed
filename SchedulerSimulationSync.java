...
// Added synchronization libraries
...
class SharedResources {
    ...
    public static void incrementContextSwitch() {
        // Acquire lock before updating shared counter
        counterLock.lock();
        try {

            // Critical section for context switch counter
            contextSwitchCount++;
    ...
    public static void incrementCompletedProcess() {
        ...
        try {
            ...
            // Critical section for completed process counter
    ...
    public static void addWaitingTime(long time) {
        // Acquire lock before updating waiting time
        counterLock.lock();

        try {

            // Critical section for total waiting time
    ...
    public static void logExecution(String message) {
        // Acquire lock before updating shared execution log
        logLock.lock();

        try {

            // Critical section for execution log
...
class Process implements Runnable {
    ...
    public void run() {
        ...
        try {
            // Acquire CPU semaphore before process execution
...
public class SchedulerSimulationSync {
    public static void main(String[] args) {
        ...
        int studentID = 445052202; // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
